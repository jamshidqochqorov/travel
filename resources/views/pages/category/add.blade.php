    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Kategoriya</h4>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('categoryCreate')}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control {{$errors->has('name') ? "parsley-error":"" }}" name="name" value="{{old('name')}}" >
                        ...
                        <div class="mb-3">
                            <label for="formrow-firstname-input" class="form-label ">Narhi</label>
                            <input type="text" class="form-control {{$errors->has('price') ? "parsley-error":"" }}" name="price" value="{{old('price')}}" >
