    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Clentlar </h4>
        ...
        <div class="col-xl-6 offset-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('clientCreate')}}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{old('count')}}" type="text" class="form-control {{$errors->has('count') ? "parsley-error":"" }}" name="count" >
